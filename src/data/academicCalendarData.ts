    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AC_AY2024-25_E1.pdf",
        badge: "Engineering - I",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC_AY2024-25_P2_E2_E3.pdf",
        badge: "PUC-II & E2/E3",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC_AY2024-25_E4.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCalender2023-24S2.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCalender2023-24.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCalender2022-23.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCalenderP2S12020-21.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCalenderEnggS12020-21.pdf",
  ...
  },
  {
    ...
    documents: [
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY2019-2020-PUC-ISEM-1UpdatedAcademicCalendar.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY2019-2020-PUC-ISEM-IIAcademicCalendar.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY2019-2020-SEM-II-PUC-IIAcademicCalendar.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY2019-2020-SEM-II-EnggAcademicCalendar.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AC2018-19_P2-E4.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC2018-19_P1.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AC1718S1_Revised.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC1718WS1_Revised.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC1718S2_Revised.pdf",
      ...
      },
      {
        ...
        pdfUrl: "/pdfdoc/AC1718SS2_Revised.pdf",
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AY201617S1Calendar.pdf",
        badge: "Semester - 1",
        scope: "First Semester Calendar"
      },
      {
        ...
        pdfUrl: "/pdfdoc/AcademicCSem22017.pdf",
        badge: "Semester - 2 (Revised)",
        scope: "Revised Second Semester Calendar"
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY201617SSCalendar-rev2.pdf",
        badge: "Summer Semester (Revised)",
        scope: "Revised Summer Term Schedule"
      }
    ]
    ...
    documents: [
      {
        ...
        pdfUrl: "/pdfdoc/AY201516S1Calendar.pdf",
        badge: "Semester - 1",
        scope: "First Semester Calendar"
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY201516S2Calendar.pdf",
        badge: "Semester - 2",
        scope: "Second Semester Calendar"
      },
      {
        ...
        pdfUrl: "/pdfdoc/AY201516SSCalendar.pdf",
        badge: "Summer Semester",
        scope: "Summer Term Schedule"
      }
    ]
