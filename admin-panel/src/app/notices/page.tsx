...
export default function NoticesPage() {
  ...
  const loadNotices = async () => {
    ...
    try {
      ...
      setNotices(data.filter(n => n.category !== "News"));
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div>
              ...
              <select 
                className="w-full border border-slate-200 rounded-xl px-4 py-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all text-sm outline-none shadow-sm appearance-none"
